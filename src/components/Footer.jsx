  ...
  return (
    <footer className="bg-[#1C1815] border-t border-[#2C2420] py-10">
      <div className="max-w-7xl mx-auto px-8 md:px-16 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <p className="font-['DM_Sans'] text-xs text-[#4A3F38] text-center">
          © 2025 Vanessa Aguilar Benipayo · BS Architecture · National University Manila
        </p>
        <a
          href="mailto:benipayovanessa@gmail.com"
          className="font-['DM_Sans'] text-xs tracking-[0.15em] uppercase text-[#4A3F38] hover:text-[#B09070] transition-colors duration-300"
        >
